...
\begin{itemize}
    \item \textbf{Hand Tracking}: Valve benützt bei der Valve Index deren eigenen zwei Controller.
    Diese Controller müssen nicht gehalten werden.
    Dies bedeutet, dass der Controller losgelassen werden kann.
    Somit können die Finger frei bewegt werden.
    Durch Sensoren an dem Controller können daraufhin die Positionen und Bewegungen des Controllers getrackt werden.
